      ...
      var ajaxCall = function(data, callback, merge) {
        ...
        $.ajax({
          ...
          error: function(response, textStatus, errorThrown) {
            ...
            console.log("this is a blasphemous piece of code, but had to do it in interest of saving time");
            console.log("ignore the error in case of deleteSummaryGroups and reload the page")
            if (data.action == "deleteSummaryGroups") {location.reload();}
