...
from annotator import create_span, delete_span, collate_on_entity, delete_grouped_spans
...
DISPATCHER = {
        ...
        'collateBasedOnEntity' : collate_on_entity,
        'deleteSummaryGroups' : delete_grouped_spans,
